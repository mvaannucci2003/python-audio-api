...
CATEGORIES = {
    ...
    "Mass/Thin": ["thin", "empty", "light", "compact", "weak", "narrow"],
    "Mass/Thick": [
        "fat",
        "full",
        "rich",
    ...
    "Texture/Smooth": ["smooth", "pure", "clean", "clear", "fluid"],
    "Texture/Rough": [
        "rough",
        "raspy",
        "grainy",
    ...
    "Dynamic/Stable": ["constant", "continuous", "even"],
    "Dynamic/Variable": [
        "fluctuating",
        "irregular",
        "uneven",
    ...
    "Spatial/Distant": ["far", "reverb", "open", "airy", "breathy", "hollow", "quiet"],
    "Spatial/Near": [
        "near",
        "direct",
        "focused",
    ...
    "Harmonic/Damped": ["muffled", "constrained", "low", "muted", "nasal"],
    "Harmonic/Resonant": ["resonant", "high", "tonal", "complex", "rich", "vibrant"],
    "Valence/Artificial": ["annoying", "aggrrssive", "artificial", "noisy"],
    "Valence/Natural": ["beutiful", "pretty", "sweet", "gentle", "calm", "natural"],
    "Material": [
        "woody",
        "metallic",
        "brassy",
